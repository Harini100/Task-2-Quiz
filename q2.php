...
{
		    echo "<center>Congrats &nbsp".$p."!&nbspYou have got it right </center><br>";
			echo "<center>Now proceed to the next question</center>";
		    echo "<br><br>";
//			$session = implode(", ", $_SESSION['qui']);
		//	$query = "select * from quiz WHRE `qid` NOT IN (".$session.") order by rand() LIMIT 1;";
